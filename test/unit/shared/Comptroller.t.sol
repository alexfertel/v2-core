...
contract Comptroller_Unit_Shared_Test is Base_Test {
    ...
    function deployConditionally() internal {
        if (!isTestOptimizedProfile()) {
            ...
            comptroller = SablierV2Comptroller(
                deployCode("out-optimized/SablierV2Comptroller.sol/SablierV2Comptroller.json", abi.encode(users.admin))
            );
        }
